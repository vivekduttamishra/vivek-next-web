...
import { faBars, faTimes, faSearch, faShoppingCart, faChevronDown, faChevronUp } from '@fortawesome/free-solid-svg-icons';
          ...
          <nav className="main-menu">
            ...
            <div className="menu-item-container">
              ...
              >
                <span>Books</span>
                <FontAwesomeIcon 
                  icon={showBooksSubmenu ? faChevronUp : faChevronDown} 
                  className="ms-2"
                />
              </div>
              {showBooksSubmenu && (
